...
public class SpeechAnalyzerTranscriber: NSObject, SpeechTranscriptionProtocol, @unchecked Sendable {
    ...
    public func prepare() async throws {
        ...
        do {
            ...
            logger.warning("Could not test microphone permission, requesting explicitly")
            hasPermission = false
        }
        ...
        do {
            ...
            if supportedLocales.isEmpty {
                ...
                guard supportedLocales.contains(self.locale) else {
                    ...
                    if let fallbackLocale = supportedLocales.first(where: { $0.language.languageCode?.identifier == self.locale.language.languageCode?.identifier }) {
